...
Если эти задания делаются спокойно, дальше можно переходить к следующей идее: массив с полями персонажа — это ещё не объект. В следующем уроке начнём собирать первого настоящего персонажа как класс, и проверки будут уже не функций, а методов объекта.
